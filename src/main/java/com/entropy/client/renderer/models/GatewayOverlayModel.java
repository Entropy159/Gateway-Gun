...
public class GatewayOverlayModel extends EntityModel<Gateway> {
    ...
    public static ModelData getModelData() {
        ...
        ModelPartData base = modelPartData.addChild(
            "base", ModelPartBuilder.create(),
            ModelTransform.of(0.0F, 8, 0.0F, 0.0F, 0.0F, 0.0F)
        );
...
//                .texOffs(0, 16)
                .cuboid(
                    -8.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F,
                    new Dilation(0.0F)
                ).mirrored(),
            ModelTransform.of(0.0F, -8.0F, 0.0F, 0.0F, (float) Math.PI, 0.0F)
        );
        return modelData;
    }
    
    public static TexturedModelData getTexturedModelData() {
        return TexturedModelData.of(getModelData(), 16, 32);
    }
